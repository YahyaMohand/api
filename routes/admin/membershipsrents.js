...
router.post('/memberships/create/:userid',requireSignin,isAuth,isAdmin,createMembership)
// router.get('/subcategories/create/:userid',requireSignin,isAuth,isAdmin,addSubCate)
router.post('/membershipspersons/create/:userid',requireSignin,isAuth,isAdmin,addPeopletomemship)
...
router.get('/memberships/:userid', requireSignin,isAuth,isAdmin,getMemrents)
router.put('/memberships/update/:id/:userid',requireSignin,isAuth,isAdmin,updateMembershiprent)
router.get('/memberships/:id/:userid',requireSignin,isAuth,isAdmin,getMemrentById)
router.get('/memberships/update/:id/:userid',requireSignin,isAuth,isAdmin,getMemrentById)
router.put('/membershipspersons/update/:id/:userid',requireSignin,isAuth,isAdmin,updateMemPeople)
router.get('/membershipspersons/update/:id/:userid',requireSignin,isAuth,isAdmin,getPeoplebyid)
